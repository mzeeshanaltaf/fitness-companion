...
faq_data = {
        'What this Application is about?':
            '<p>NutriFit is your all-in-one fitness companion! Given your profile and fitness goal, it provides you '
            'personalized nutrition and workout plan</p>',
        ...
        'I want to make modification in the application. Can I get the application source code?':
            ...
            '<a href="https://github.com/mzeeshanaltaf/fitness-companion">GitHub</a></p>',
